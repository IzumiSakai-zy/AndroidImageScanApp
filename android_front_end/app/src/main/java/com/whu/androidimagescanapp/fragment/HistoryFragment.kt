...
class HistoryFragment : Fragment() {
    ...
    private fun setItemList() {
        itemList = listOf(
            HistoryItem(
                HistoryItem.CLASSIFICATION_TYPE,
                R.drawable.search_dog_item_1,
                requireContext().getString(R.string.main_page_predicted_result)
            ),
            HistoryItem(
                HistoryItem.CLASSIFICATION_TYPE,
                R.drawable.history_horse_1,
                "It's a horse"
            ),
            HistoryItem(
                HistoryItem.OCR_TYPE,
                R.drawable.history_ocr_1,
                "在北伐大军;全局已定的开下一左簿相李善长率众官于朱元璋面月劝进二至正三于从年:3136833E月初"
            ),
            HistoryItem(
                HistoryItem.CLASSIFICATION_TYPE,
                R.drawable.history_airplane_1,
                "It's a airplane"
            ),
